...
The optical properties of whole leaves depend on the pigment content and the localization of these pigments, together with tissue structural properties that scatter light increasing the distance travelled by photons within leaves [@Johnsen2011; @Lee2010]. Heterogeneous or patchy distribution of pigments alters the relationship between concentration and light absorption. Absorption of photons by chlorophylls and auxiliary pigments is a pre-requisite for photosynthesis. Non-photosynthetic pigments located in the epidermis are important as they screen potentially damaging photons. Photoreceptors are in too low a concentration to significantly affect optical properties of leaves, but the properties of light that inpings on them is affected by these properties
...
Many studies have indicated that UV-absorbing compounds in the vacuoles of epidermal cells play a major role in attenuating UV levels within leaves. However, absorbing compounds located in cell walls and other cell parts can also be important in decreasing UV penetration. These compounds are usually not easily extractable, and consequently one cannot rely on extracts alone when judging the effectiveness of UV-screening protection. Furthermore, both wax deposits and pubescence can be important for protection against UV radiation [@Karabourniotis1999; @Holmes2002]. While pigments absorb the screened photons, wax deposits and some types of pubescence rely additionally on reflection. The degree of UV-protection can also vary over time, even during the day, probably as a result of changes in flavonoid concentrations [@Barnes2008a; @Veit1996]. The expression of these protection mechanisms is plastic, i.e., subject to acclimation. Thus, expression of leaf properties conferring protection also depend on environmental factors, in particular prior exposure to UV radiation or strong visible radiation, and large differences in genotype and phenotype exist among plant species and to a lesser extent within species.

Mechanisms for screening of visible radiation exist in leaves of some species. The role of anthocyanins as screens remains controversial, while the role of pubescence towards reduction of absorbed energy is well demonstrated. As absorbed radiative energy contributes to the energy balance of leaves, the evolution of leaf optical properties in hot climates has been influenced by features that help prevent excessive warming of leaves [@Lee2010]. In addition to tissue and cell damage by extreme temperatures, the rates of transpiration, photosynthesis and respiration depend on temperature.
...
Spectroscopy of reflected radiation is the basis of optical remote sensing, in the case of drones, aeroplanes and satellites. Spectroscopy can be also a very useful measuring approach at the scale of individual plants and plant organs, including leaves. Frequently, these approaches have relied on instruments with low wavelength resolution, e.g., a few rather broad bands. Modern spectral and hyperspectral cameras have higher wavelength resolution but data analysis still tends to rely on rather broad bands. While remote sensing only relies on reflected light, local optical measurements of whole leaves and flower petals and sepals can include reflectance, absorptance and transmittance informing about combined effects of pigments and structural features, and even distinguish between them. 

It is important to remember when studying plants that light scattering plays a very important role in determining their optical properties [@Lee2010]. One possible way of quantifying scattering within leaves is to measure the time a very brief laser pulse takes to travel across a leaf, from adaxial to abaxial epidermis (L.O. Björn, personal communication). A way of visualizing the contribution to light scattering of the water-air interfaces within leaves is to infiltrate the air spaces with water in a vacuum chamber. If we infiltrate a variegated leaf, the white parts lacking chlorophyll turn almost transparent and the dark green regions containing chlorophyll become semi-transparent with a green tint. As scattering mostly originates at air-water interfaces within leaves, eliminating these interfaces by filling air spaces with water drastically reduces scattering concurrently with the probability of photons being absorbed. Scattering lengthens the path of photons within the leaf increasing the probability of each photon being intercepted by a pigment molecule. Light reflection in most part takes place within leaves, not at the surface of the epidermis.
...
**TO DO: Add illustrations of setups, including probes and spheres, and explain the protocols used.**

### Optical estimation of chlorophyll content

As explained above, both pigments and scattering affect transmittance in a heterogeneous medium such as leaves. A simple measurement of leaf transmittance at a wavelength where chlorophyll absorbs strongly enough provides a rough estimate of the concentration of chlorophyll, that can be used with a suitable case-specific calibration. This requires very simple equipment, but is rather impractical as readings are highly dependent on scattering within leaves, and scattering depends on the anatomy. Commercially available instruments, such as the SPAD-502Plus (Konica Minolta), CCM-200 (Opti-Sciences), the Dualex 4.0 (METOS, Pessl Instruments), LSA-2050 (Walz) and others apply a correction to transmittance observed in the red or far-red based on transmittance to longer waevlengths in the NIR, where leaves have very low absorptance and scattering predominates. The Dualex 4 measures transmittance at a wavelength in the far-red (near 710 nm, i.e., close to the so-called "red edge"), thus outside the region of maximum absorption of chlorophylls, using an even longer wavelength (near 820 nm) as reference for scattering. In contrast, the CCM-200 uses 653 nm and 931 nm, and the SPAD-502 uses the very similar 650 nm and 940 nm. So these instruments measure absorbance in the red where chlorophyll absorption is higher than at 710 nm. Using a correction for scattering makes the calibration against chlorophyll concentration _less_ dependent on leaf anatomy and species. Thus, for within-experiment comparisons, in many cases it is possible to rely on calibrations that are only instrument dependent (@Markwell1995). Still, for accurate measurements expressed as chlorophyll concentration per unit leaf area, a calibration against photometric measurements in leaf extracts can be necessary. The values returned by the SPAD instrument are in arbitrary units and their relationship to concentration is slightly curvilinear. The Dualex returns approximate concentration values in $\mu g\, cm^{-2}$ based on a built-in _generic_, and thus, approximate calibration. The relationship between these estimates and true concentration is linear in the case of the Dualex.
