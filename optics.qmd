...
![Specular and diffuse reflection [source](https://commons.wikimedia.org/wiki/File:Lambert2.svg) temporary fill to be replaced by figure redrawn from Gates, D (1980) Figure 8.35.](figures/Lambert2.png){#fig-reflection fig-alt="Diagram" width="50%"}
...
(autoplot(Ler_leaf.spct, annotations = "boundaries") + theme_minimal()) /
     (autoplot(Ler_leaf_trns.spct, annotations = "boundaries") + theme_minimal()) /
