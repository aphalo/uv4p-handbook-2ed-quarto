...
Plants respond to the degree of scattering of light and to the direction of the light. Light sources differing in their collimation are not equivalent. If the aim is to study effects of irradiance or wavelength, the geometry of the light field must be consistent. Typical cases when this is not true are: 1) Identical light sources at different distance from plants; 2) LEDs with different HMFW angle for light emission; 3) LEDs and laser diodes; 4) gas discharge lamps and LED arays; 5) sunlight on opposite sides of a greenhouse; 6) different distance to reflecting walls; etc.
